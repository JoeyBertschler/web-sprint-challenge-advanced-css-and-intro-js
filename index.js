...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
(no function needed) 
There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh 
is currently Vincent Van Dough. Use an array method to fix this issue and 
...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 3: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀  
 ...
 Example, if getArtistByIndex is invoked with the artists array and the number 0, 
...
// change:      "years": "1884 - 1920"     to number how?
function get20s(arr){
  parseInt(arr[0].years, 10)
  return console.log(arr[0].years)
}
get20s(artists) //returns string as is...

// after number, how conditional? "return new array" make new array with origin. value + modifications how?
// time running out. weaknesses: insufficient grasp of certain methods, syntax and a lack of practice
// solution: asking instructors for help, initialize new exercises & get started on next module/assignment early
// to ensure sufficient time & accomplishment
...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 5: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
 ...
 For example, if removeArtist is invoked with the artists array and the number 0, 
  it will remove Amedeo Modigliani from our dataset and return the number 19. */
...
Example: addArtist(artists) should return the artists array with the 
above object added to the end of the array. */
...
addArtist(artists, "joey", "28", "web dev", "austria", "content marketer" )
